...
{
	[Library]
	public partial class PTRPlayerMovement : BasePlayerController 
	{
		[Net] public float SprintSpeed { get; set; } = 180.0f;
		// [Net] public float WalkSpeed { get; set; } = 150.0f;
		[Net] public float DefaultSpeed { get; set; } = 85.0f;
